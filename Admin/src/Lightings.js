...
function Doorbells() {
  ...
  const getProducts = () =>{
    fetch('http://localhost:8001/api/getProducts', {
      method: 'POST',
      headers: {
  ...
  const handleDelete = async ({...product}) =>{
    try{
      ...
      const response = fetch('http://localhost:8001/api/deleteProduct', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  //     let productName = prd.productName;
  //     console.log(productName)
  //     const response = fetch('http://localhost:8001/api/updateProduct', {
  //     method: 'POST',
  //     headers: {
  //       'Content-Type': 'application/json',
  //     },
